# Day 3 of Advent of Code 2023 - Part 1
#
...
with open(SAMPLE_INPUT, 'r') as file:
    ...
    while c:
        if c in number_set:
            ...
            if c in symbol_set:
                symbols.append((line_counter, width_counter))
    ...
    for symbol_location in symbols:
        added = []
        neighbors = get_neighbors(symbol_location, line_width, file_height)
        ...
        for neighbor in neighbors:
            ...
            if neighbor_value != -1 and not neighbor_value in added:
                ...
                sum += number_values[neighbor_value]
